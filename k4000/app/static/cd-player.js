(() => {
  ...
  function open() { window.stopRadioForCd?.(); player.classList.add('open'); player.setAttribute('aria-hidden','false'); loadLibrary(true); render(); }
